...
const getExperiencesByCategory = (latitude: number, longitude: number, categoryId: number) => getRequest(`/api/experiences/find/category?latitude=${latitude}&longitude=${longitude}&distance=5&categoryId=${categoryId}`);
...
export const useGetExperiencesByLocation = (latitude: number, longitude: number, onSuccess: (data: Experiences) => void, onError: (data: Experiences) => void) => {
  ...
  export const useGetExperiencesByCategory = (latitude: number, longitude: number, categoryId: number, onError: (data: Experiences) => void) => {
