  ...
  return (
    <div className="w-full flex flex-col justify-between pb-6">
      <div className="w-full max-w-6xl flex flex-col md:mx-auto gap-9">
        <div className="w-full h-56 md:h-72 bg-red-400 flex items-center justify-center text-3xl text-white font-bold">
          Lorem impsum
        </div>
        <div className="w-full flex flex-col gap-6 px-6 xl:px-0">
          ...
          <div className="w-full flex flex-col md:flex-wrap md:flex-row gap-6 items-center justify-center">
            {cards
              ? cards.map((card) => (
                <Card key={card} />
                ))
